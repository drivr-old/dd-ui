...
If you use jspm run `jspm install dd-ui=github:clickataxi/dd-ui@0.6.3`
...
Don't worry, if you are not sure which file to take, opt for `dd-ui-tpls-[version].min.js`.
