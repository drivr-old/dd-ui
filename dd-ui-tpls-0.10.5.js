...
angular.module("template/filter-tags/filter-tags.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("template/filter-tags/filter-tags.html",
    ...
    "            <span class=\"clear-all-icon\">&#10005</span>\n" +
    "        </button>\n" +
    "    </div>\n" +
    "    <div class=\"btn-group\">\n" +
    "        <button type=\"button\" ng-click=\"$ctrl.clearAll()\" class=\"btn btn-default btn-sm btn-clear-tags\"><span class=\"clear-all-icon\">&#10005</span> Clear all</button>\n" +
    "    </div>\n" +
    "</div>");
}]);
...
angular.module('dd.ui.filter-tags').run(function() {!angular.$$csp().noInlineStyle && angular.element(document).find('head').prepend('<style type="text/css"> .filter-tags{margin-top:15px;margin-bottom:15px;}.filter-tags .btn{background-image:none;}.filter-tags .btn-info{background:#44bbf6 !important;background-image:none;}.filter-tags .btn-info:hover,.filter-tags .btn-info:focus,.filter-tags .btn-info:active{background:#23b1f7 !important;}.filter-tags .btn-group{margin-right:10px;margin-bottom:10px;}.filter-tags .btn-group .btn:first-child{margin-right:2px;}</style>'); });
